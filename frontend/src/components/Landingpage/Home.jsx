    ...
    <>
      <section className="h-5/6 mx-auto max-w-screen-xl pb-4 px-4 items-center lg:flex md:px-8">
        <div className="space-y-4 flex-1 sm:text-center lg:text-left">
          ...
          <p className="text-gray-500 max-w-xl leading-relaxed sm:mx-auto lg:ml-0 lg:text-lg md:text-lg">
          ...
          <div>
            <button
              ...
              className="outline-none bg-indigo-600 text-white md:text-lg text-center px-4 py-3 rounded-md shadow w-full ring-offset-2 ring-gray-700 focus:ring-2  sm:w-auto"
            >
              Get started
            </button>
          </div>
        ...
        <div className="flex-1 text-center mt-4 lg:mt-0 lg:ml-3">
          <img
            ...
            className="w-full h-full mx-auto sm:w-10/12  lg:w-full"
            alt="img"
          />
        </div>
      </section>
