...
const admin =
  "CREATE TABLE if not exists admin (AID VARCHAR(255) PRIMARY KEY,name VARCHAR(255), email VARCHAR(255), password VARCHAR(255), phone VARCHAR(255), address VARCHAR(255) )";
database.query(admin, function (err, result) {
  if (err) return console.log(err);
});
const employee =
  "CREATE TABLE if not exists employee (EID VARCHAR(255) PRIMARY KEY,name VARCHAR(255), age VARCHAR(255), NID VARCHAR(255), address VARCHAR(255), phone VARCHAR(255), email VARCHAR(255), password VARCHAR(255) )";
